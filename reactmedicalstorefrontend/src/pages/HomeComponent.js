					...
					<div className="row clearfix">
						<div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div className="info-box bg-pink hover-expand-effect">
								...
								<div className="content">
									<div className="text">TOTAL EMPLOYEES</div>
									<div
										className="number count-to"
										data-from="0"
										data-to="125"
						...
						<div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div className="info-box bg-light-green hover-expand-effect">
								...
								<div className="content">
									<div className="text">TOTAL SALES AMT</div>
									<div
										className="number count-to"
										data-from="0"
										data-to="243"
						...
						<div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div className="info-box bg-orange hover-expand-effect">
								...
								<div className="content">
									<div className="text">MED EXPIRE(WEEK)</div>
									<div
										className="number count-to"
										data-from="0"
										data-to="1225"
					...
					<div className="row clearfix">
						<div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div className="info-box bg-pink hover-expand-effect">
								...
								<div className="content">
									<div className="text">COMPLETED REQ</div>
									<div
										className="number count-to"
										data-from="0"
										data-to="125"
						...
						<div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div className="info-box bg-light-green hover-expand-effect">
								...
								<div className="content">
									<div className="text">TODAY SALES AMT</div>
									<div
										className="number count-to"
										data-from="0"
										data-to="243"
						...
						<div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div className="info-box bg-orange hover-expand-effect">
								...
								<div className="content">
									<div className="text">TODAY PROFIT</div>
									<div
										className="number count-to"
										data-from="0"
										data-to="1225"
