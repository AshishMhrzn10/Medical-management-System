...
class BillGenerateComponent extends React.Component {
	...
	billGeneratePrint(customer_name, address, phone, medicineDetails) {
		var billDetails =
			"<style>table{width:100%; border-collapse:collapse;} td{padding:5px} td{padding:5px}</style><div>";
									...
									<form onSubmit={this.formSubmit}>
										...
										{this.state.medicineDetails.map((item, index) => (
											<div className="row" key={index}>
												...
												<div className="col-lg-2">
													<label htmlFor="email_address">Quantity Type:</label>
													<div className="form-group">
														<div className="form-line">
															<input
																type="text"
												...
												<div className="col-lg-2">
													<label htmlFor="email_address">Total Amount:</label>
													<div className="form-group">
														<div className="form-line">
															<input
																type="text"
